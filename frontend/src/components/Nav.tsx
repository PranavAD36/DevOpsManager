        ...
        <div className="mx-auto max-w-7xl px-6 py-0">
          <div className="flex h-14 items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-cyan-500/20 to-violet-500/20 border border-cyan-500/20 group-hover:border-cyan-400/40 transition-colors">
                <svg className="w-4 h-4 text-cyan-400 shrink-0" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                href="/github/connect"
                className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-[#1e2d4a] bg-[#0c111e]/60 hover:border-cyan-500/30 transition-colors"
              >
                {avatarUrl ? (
                  <img
                    src={avatarUrl}
                    alt={githubUser || 'GitHub'}
                    width={18}
                    height={18}
                    className="w-4.5 h-4.5 rounded-full object-cover shrink-0 border border-slate-700"
                ...
                <span className="text-xs text-slate-300 font-mono hidden md:inline">
                  {githubConnected ? `@${githubUser}` : 'Connect GitHub'}
                </span>
              </Link>
              ...
              {githubConnected && (
                <button
                  ...
                  className="flex items-center justify-center p-1.5 rounded-lg border border-[#1e2d4a] bg-[#0c111e]/60 hover:bg-red-500/10 hover:border-red-500/30 text-slate-400 hover:text-red-400 transition-colors"
                >
